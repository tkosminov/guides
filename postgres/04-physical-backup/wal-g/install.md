...
*Срок продления указывается таким образом*

```bash
5y
```

*Ключ также имеет subkeys, которые тоже нужно продлить. Команды для продления те же самые. Для переключения на subkeys:*
...
**После продления необходимо заново экспортировать ключи в текстовые файлы для wal-g и выдать им права**
